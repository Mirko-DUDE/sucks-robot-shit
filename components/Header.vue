<template>
  <header
    ...
    <div
      class="absolute invisible opacity-0 flex justify-center items-center top-0 left-0 bg-black font-bold text-white text-24 lg:text-56 leading-35 lg:leading-64 uppercase w-screen h-screen z-10"
      ref="menu">
